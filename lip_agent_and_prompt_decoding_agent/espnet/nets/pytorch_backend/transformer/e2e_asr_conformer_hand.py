...
class E2E_hand(torch.nn.Module):
    def __init__(self, odim, args, ignore_id=-1):
        ...
        self.hand_mapping = torch.nn.Linear(odim,args.adim)
        self.mapping_ratio = torch.nn.Parameter(torch.tensor(0.1))
        # self.lsm_weight = a
    ...
    def forward(self, x, lengths, label, hand_matrix):
