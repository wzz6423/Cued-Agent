...
from espnet.nets.pytorch_backend.ctc_free import CTC_free
...
class E2E_hand_free(torch.nn.Module):
    def __init__(self, odim, args, ignore_id=-1,hand_weight=0.1):
        ...
        if args.mtlalpha > 0.0:
            self.ctc = CTC_free(
                odim, args.adim, args.dropout_rate, ctc_type=args.ctc_type, reduce=True,hand_weight=hand_weight
            )
        else:
            self.ctc = None
