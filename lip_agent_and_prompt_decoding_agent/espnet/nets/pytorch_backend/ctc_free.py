...
class CTC_free(torch.nn.Module):
    """CTC module
    ...
    def __init__(self, odim, eprojs, dropout_rate, ctc_type="builtin", reduce=True, hand_weight=0.1):
        super().__init__()
    ...
    def log_softmax(self, hs_pad, hand_matrix=None):
