...
"""Transformer speech recognition model (pytorch) - Clean version matching original Auto-AVSR."""
...
class E2E_Clean(torch.nn.Module):
    """Clean E2E model matching original Auto-AVSR architecture (no custom modifications)."""
    ...
    def forward(self, x, lengths, label):
        ...
        # Standard encoder forward (no DynamicFeatureModule)
        ...
        # Combined loss (no intermediate CTC)
